...
export const pageMeta = {
    ...
    text: "O maior arremessador de 3 pontos da historia da NBA",
    // Palavra-chave para o VÍDEO de fundo
    videoQuery: "basketball",
    // Nome do "diretor" (o usuário)s
    authorName: "Wendel Bleinat",
    // Gênero do filme para dar um toque extra
    genre:"Esportes",
    // Cor principal para detalhes e legendas
    primaryColor: "#f58a07ff", // Um azul elétrico
